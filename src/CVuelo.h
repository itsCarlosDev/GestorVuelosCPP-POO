...
class CVuelo
{
    public:
        ...
        CVuelo();
        CVuelo(int id, int Duracion, int Precio, int maxPasajeros, CPiloto piloto1, CPiloto piloto2); // Constructor con parametros
        //~CVuelo(); // Destructor
    ...
    private:
        ...
        int m_IDAvion; // A cada vuelo se le tiene que asignar un avion
